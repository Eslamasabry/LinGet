...
LinGet is pre-1.0 software. Back up important systems and review every operation plan before approving package changes.
...
Provider guarantees differ by tier. Review [Provider support](docs/provider-support.md) before relying on an operation.
